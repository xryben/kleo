      ...
      <div className="min-h-screen">
        <header className="border-b border-slate-800 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <Link href="/infoproductor/campaigns" className="text-lg font-bold text-white">
              Cleo
            </Link>
          </div>
        </header>
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        {campaign.description && <p className="text-slate-400 mb-6">{campaign.description}</p>}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white mb-4">
              Clips incluidos ({campaign.clips.length})
            </h2>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-400">
                        {clipper.views.toLocaleString()} vistas
                      </div>
                    </div>
                    <div className="text-green-400 font-medium text-sm">
                      ${clipper.earnings.toFixed(2)}
                    </div>
                  </div>
                ))}
              </div>
